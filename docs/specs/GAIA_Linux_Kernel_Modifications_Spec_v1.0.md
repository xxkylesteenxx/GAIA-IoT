...
- PREEMPT_RT is mandatory for deterministic GAIA control paths
- Consciousness-aware prioritization should use `sched_ext` before invasive scheduler forks
- cgroup v2 should be used as the reservation envelope, not as the whole answer
- GUARDIAN belongs in the Linux Security Module path

---

## 3. Required kernel config
